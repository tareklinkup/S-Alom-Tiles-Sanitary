                        ...
                        <table _a584de>
                            ...
                            <tbody>
                                <tr v-for="(product, sl) in cart">
                                    ...
                                    <td>{{ parseFloat(product.total_sft).toFixed(2) }}</td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ cart.reduce((p, c) => { return +p + +c.PurchaseDetails_TotalQuantity }, 0) }}</td>
                                    <td>{{ cart.reduce((p, c) => { return parseFloat(+p + +c.total_sft).toFixed(2)}, 0) }}</td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                </tr>
