                        ...
                        <table _a584de>
                            ...
                            <tbody>
                                <tr v-for="(product, sl) in cart">
                                    ...
                                    <td>{{ product.size }}</td>
                                    <td>{{ product.grade }}</td>
                                    <td>{{ product.SaleDetails_TotalQuantity | decimal}} {{ product.Unit_Name }}</td>
                                    <td>{{ product.total_sft | decimal }}</td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ cart.reduce((p, c) => { return +p + +c.SaleDetails_TotalQuantity }, 0).toFixed(2) }}</td>
                                    <td>{{ cart.reduce((p, c) => { return +p + +c.total_sft}, 0).toFixed(2) }}</td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                </tr>
