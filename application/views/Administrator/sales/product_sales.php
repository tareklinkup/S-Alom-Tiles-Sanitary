						...
						<div class="col-sm-5">
							<form v-on:submit.prevent="addToCart">
								...
								<div class="form-group">
									...
									<label class="col-sm-1 control-label" style="    position: relative;left: -16px">Brand</label>
									<div class="col-sm-4">
								...
								<div class="form-group">
									...
									<label class="col-sm-1 control-label no-padding-right"> Sft </label>
									<div class="col-sm-4">
										<input type="text"  placeholder="Sft" class="form-control"  v-model="selectedProduct.totalSft" v-on:input="productTotal" readonly/>
									</div>
								</div>
			...
			<div class="table-responsive">
				<table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
					...
					<tbody style="display:none;" v-bind:style="{display: cart.length > 0 ? '' : 'none'}">
						...
						<tr>
							<td colspan="8"><textarea style="width: 100%;font-size:13px;" placeholder="Note" v-model="sales.note"></textarea></td>
...
<script>
	...
	new Vue({
		...
		methods:{
			...
			productTotal(){
				this.selectedProduct.totalSft = (parseFloat(this.selectedProduct.quantity) * parseFloat(this.selectedProduct.sft != '' ? this.selectedProduct.sft : 0)).toFixed(2);

				this.selectedProduct.total =  this.selectedProduct.convert_type == 'Sft' ? parseFloat(this.selectedProduct.totalSft * this.selectedProduct.Product_SellingPrice).toFixed(2) : this.selectedProduct.quantity * this.selectedProduct.Product_SellingPrice;
			},
			onSalesTypeChange(){
