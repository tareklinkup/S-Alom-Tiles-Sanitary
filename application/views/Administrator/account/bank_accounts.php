                ...
                <form action="" class="form-horizontal" @submit.prevent="saveAccount">
                    <div class="row">
                        <div class="col-md-4 col-md-offset-2">
                            ...
                            <div class="form-group">
                                <label for="" class="control-label col-md-4">Is Loan Acc</label>
                                <div class="col-md-8">
                                    <input type="checkbox" v-model="account.is_loan_account">
                                </div>
                            </div>
                        </div>
                            ...
                            <datatable :columns="columns" :data="accounts" :filter-by="filter">
                                <template scope="{ row }">
                                    <tr>
                                        ...
                                        <td>{{ row.is_loan_account == 1 ? 'Yes' : 'No' }}</td>
    ...
    new Vue({
        ...
        data(){
            return {
                ...
                columns: [
                    ...
                    { label: 'Is Loan Account', field: 'is_loan_account', align: 'center' },
        ...
        methods: {
            ...
            editAccount(account){
                ...
                this.account.is_loan_account = parseInt(account.is_loan_account);
            },
