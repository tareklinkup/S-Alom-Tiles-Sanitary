    ...
    new Vue({
        ...
        methods: {
            ...
            getTransactions(){
                ...
                axios.post('/get_bank_transactions', this.filter)
                .then(res => {
                    this.transactions = res.data.map(tr => {
                        tr.deposit = tr.transaction_type == 'deposit' ? tr.amount : 0;
                        tr.withdraw = tr.transaction_type == 'withdraw' ? tr.amount : 0;
                        return tr;
                    });
                })
                .catch(error => {
